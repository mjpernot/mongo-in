...
# Description:
  Used to take an external JSON document (file) and insert or import into a Mongo database.
...
```
git clone git@sc.appdev.proj.coe.ic.gov:JAC-DSXD/mongo-in.git
```
...
```
test/unit/mongo_in/unit_test_run.sh
test/unit/mongo_in/code_coverage.sh
```
